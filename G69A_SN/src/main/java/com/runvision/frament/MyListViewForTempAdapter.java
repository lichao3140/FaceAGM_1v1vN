...
public class MyListViewForTempAdapter extends BaseAdapter {
                ...
                alert.setButton(DialogInterface.BUTTON_POSITIVE, "是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (ret == 0) {
                            ...
                            //删除本地模版图片
                            System.out.println("imageid:"+user.getImagepath());
                            FileUtils.deleteTempter(user.getImagepath(),"FaceTemplate");
    ...
    private class ViewHolder {
        TextView id, userID, userName, userType, creatTime,delete_temp_item;

        //Button deleteChooseItem;
        ...
        public ViewHolder(View v) {
            ...
            creatTime = v.findViewById(R.id.listview_time);
            delete_temp_item=v.findViewById(R.id.delete_temp_item);
            //deleteChooseItem = v.findViewById(R.id.deleteChooseItem);
        }
    }
}
